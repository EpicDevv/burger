      ...
      <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-y-4 sm:grid-cols-2 sm:gap-x-6 sm:gap-y-10 lg:grid-cols-3 lg:gap-x-8">
          {burgers.products.map((burger: any) => (
            <div
              key={burger.id}
              className="group relative flex flex-col overflow-hidden rounded-lg border border-[#008170] bg-white dark:bg-[#0f0f0f]"
            >
              ...
              <div className="flex flex-1 flex-col space-y-2 p-4">
                <h3 className="text-sm font-medium dark:text-[#008170]">
                  <a href={burger.href}>
                ...
                <div className="flex flex-1 flex-col justify-end">
                  ...
                  <div className="flex justify-between">
                    ...
                    <div>calories {burger.calorie}</div>
                  </div>
                </div>
              </div>
            </div>
